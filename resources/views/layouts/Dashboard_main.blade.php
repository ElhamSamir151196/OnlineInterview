  ...
  <nav id="sidebar" class="sidebar-wrapper">
    <div class="sidebar-content">
      <div class="sidebar-brand">
        <a href="{{url('/')}}">        <img style="border-radius: 50%; width: 60px; margin-right: 20px;" src="{{ asset('img/d025bf96-bf25-4d84-92ef-b6b7535c0a09.jpg')}}"/>
</a>
      ...
      <div class="sidebar-header">
        ...
        <div class="user-info">
          <span class="user-name"> {{ Auth::user()->name }}
            <strong> {{ Auth::user()->Second_name }}</strong>
          </span>
        ...
        <ul>
          ...
          <li class="sidebar-dropdown">
            ...
            <div class="sidebar-submenu">
              <ul>
                ...
                <li>
                  <a href="{{url('/create_user_by_Admin')}}">Add User </a>
                  @csrf
                </li>
          ...
          <li class="sidebar-dropdown">
            ...
            <div class="sidebar-submenu">
              <ul>
                <li>
                  <a href="{{url('/show_Questions')}}">Show Questions
                   <!-- <span class="badge badge-pill badge-success">Pro</span>-->
                  </a>
                </li>
                <li>
                  <a href="{{url('/CreateQuestion')}}">Add Question </a>
                  @csrf
                </li>
                <li>
                  <a href="{{route('question.show_category' , 1)}}">Show English Questions
                   <!-- <span class="badge badge-pill badge-success">Pro</span>-->
                  </a>
                </li>
                <li>
                  <a href="{{route('question.show_category' , 2)}}">Show IQ Questions
                   <!-- <span class="badge badge-pill badge-success">Pro</span>-->
                  </a>
                </li>
                <li>
                  <a href="{{route('question.show_category' , 3)}}">Show Technical Questions
                   <!-- <span class="badge badge-pill badge-success">Pro</span>-->
                  </a>
                </li>
